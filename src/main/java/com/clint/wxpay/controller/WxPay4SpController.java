 ...
 */
@RestController
@RequestMapping("/wx/pay/sp")
@RequiredArgsConstructor
public class WxPay4SpController {
   ...
   */
  @DeleteMapping("/closeOrder/{outTradeNo}")
  ...
  public WxPayRedpackQueryResult queryRedpack(@PathVariable String mchBillNo) throws WxPayException {
    return wxPayService.getRedpackService().queryRedpack(mchBillNo);
  }
